...
var handleRenderApexChart = function() {
	...
	var apexLineChartOptions = {
		...
		grid: {
			...
			row: {
				colors: [COLOR_GRAY_200, 'transparent'], // takes an array which will be repeated on columns
				opacity: 0.5
			},
		},
		markers: {
	...
	var apexColumnChartOptions = {
		...
		colors: [COLOR_GRAY_900, COLOR_INDIGO, COLOR_GRAY_300],
		series: [{
			name: 'Net Profit',
	...
	var apexAreaChartOptions = {
		...
		colors: [COLOR_PINK, COLOR_GRAY_900],
		series: [{
			name: 'series1',
	...
	var apexRadarChartOptions = {
		...
		plotOptions: {
			radar: {
				size: 140,
				polygons: {
					strokeColors: COLOR_GRAY_200,
					strokeWidth: 1,
					connectorColors: COLOR_GRAY_200,
					fill: {
						colors: [hexToRgba(COLOR_GRAY_300, .25), COLOR_WHITE]
					}
				}
			}
		},
